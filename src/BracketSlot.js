...
function BracketSlot(props){
    ...
    let sStyle = {textDecoration: props.controls.useS ? "none" : "line-through"}
        ...
        return (
            <div className="tooltipBox">
                ...
                <div className="tooltipText tooltipTeam1">
                    <span className="bData" style={bStyle}>B: {teamPred1.b} </span>
                    <span className="kData" style={kStyle}>K: {teamPred1.k} </span>
                    <span className="sData" style={sStyle}>S: {teamPred1.s} </span>
                    <span className="mData" style={mStyle}>M: {teamPred1.m}</span>
                </div>
                <div className="tooltipText tooltipTeam2">{`(${teamPred2.seed}) ${teamPred2.name}`}</div>
                <div className="tooltipText tooltipTeam2">
                    <span className="bData" style={bStyle}>B: {teamPred2.b} </span>
                    <span className="kData" style={kStyle}>K: {teamPred2.k} </span>
                    <span className="sData" style={sStyle}>S: {teamPred2.s} </span>
                    <span className="mData" style={mStyle}>M: {teamPred2.m}</span>
                </div>
