...
ids2 = ["2S1", "2S2", "2S3", "2S4", "2S5", "2S6", "2S7", "2S8", "2W1", "2W2", "2W3", "2W4", "2W5", "2W6", "2W7", "2W8","2E1", "2E2", "2E3",\
 "2E4", "2E5", "2E6", "2E7", "2E8", "2M1", "2M2", "2M3", "2M4", "2M5", "2M6", "2M7", "2M8"]
ids3 = ["3S1", "3S2", "3S3", "3S4", "3W1", "3W2", "3W3", "3W4", "3E1", "3E2", "3E3", "3E4", "3M1", "3M2", "3M3", "3M4"]
ids4 = ["4S1", "4S2", "4W1", "4W2", "4E1", "4E2", "4M1", "4M2"]
ids5 = ["5S1", "5W1", "5E1", "5M1"]
idsf = ["6F1", "6F2", "7F1"]
...
for i in range(4):
    output_2 = output_2 + f'"{ids5[i]}" : {{"id" : "{ids5[i]}", "team" : null, "pred1" : "4{ids5[i][1]}{int(ids5[i][2]) * 2 - 1}", "pred2" : "4{ids5[i][1]}{int(ids5[i][2]) * 2}", "succ" : "6F{"1" if ids5[i][1] == "S" or ids5[i][1] == "W" else "2"}"}},' + '\n\t'
output_2 = output_2 + '"6F1" : {"id" : "6F1", "team" : null, "pred1" : "5S1", "pred2" : "5W1", "succ" : "7F1"},\n\t'
output_2 = output_2 + '"6F2" : {"id" : "6F2", "team" : null, "pred1" : "5E1", "pred2" : "5M1", "succ" : "7F1"},\n\t'
